...
2. [Download](https://kafka.apache.org/downloads) Apache Kafka 2.0.0 or later to the system. {{site.data.reuse.long_name}} provides support for Kafka Connect if you are using a Kafka version listed in the **Kafka version shipped** column of the  [Support matrix](../../../../support/#support-matrix).
...
For more details on creating the properties files see the [connecting MQ documentation](../mq/). Make sure connection type is set to bindings mode.
