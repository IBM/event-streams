...
---------------------------------------|--------------------|-----------------------|----------------------------------|--------------------
2019.1.1                               | 1.2.0              | 2.1.1                 | - {{site.data.reuse.icp}} 3.1.1 and 3.1.2 <br/>- {{site.data.reuse.openshift}} 3.9 and 3.10 (with {{site.data.reuse.icp}} 3.1.2) <br/>- Amazon Web Services (AWS)     |  - Linux® 64-bit (x86_64) systems <br/>- Linux on IBM® Z systems
