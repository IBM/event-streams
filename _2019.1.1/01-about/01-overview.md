...
{{site.data.reuse.long_name}} is an event-streaming platform based on the open-source Apache Kafka® project.  {{site.data.reuse.short_name}} release 2019.1.1 uses the Kafka 2.1.1 release and supports the use of all Kafka interfaces.
