...
Edit the downloaded `kafka-connect.yaml` file to enable Kafka Connect to connect to your Kubernetes cluster. You can use the snippets in the {{site.data.reuse.short_name}} UI as guidance to configure Kafka Connect.
