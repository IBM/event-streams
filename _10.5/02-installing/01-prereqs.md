...
{{site.data.reuse.long_name}} 10.5.0 is supported on the {{site.data.reuse.openshift}}. Version 10.5.0 is installed by the {{site.data.reuse.short_name}} operator versions 2.5.1 and 2.5.0, and includes Kafka version 2.8.1. Always use the latest operator version to ensure you have all fixes applied.
