...
{{site.data.reuse.long_name}} 10.5.0 is supported on the {{site.data.reuse.openshift}}. Version 10.5.0 is installed by the {{site.data.reuse.short_name}} operator 2.5.0, and includes Kafka version 2.8.1.
