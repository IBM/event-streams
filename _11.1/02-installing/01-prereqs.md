...
{{site.data.reuse.long_name}} 11.1.0 is supported on the {{site.data.reuse.openshift}}. Version 11.1.0 is installed by the {{site.data.reuse.short_name}} operator version 3.1.0, and includes Kafka version 3.2.3.
