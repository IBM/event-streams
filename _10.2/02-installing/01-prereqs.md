...
- Version 10.2.1 is installed by the {{site.data.reuse.short_name}} operator versions 2.2.3, 2.2.2, and 2.2.1 by using operand version `10.2.1-eus`, and includes Kafka version 2.6.2. Always use the latest operator revision (2.2.x) for the release to ensure you have all fixes applied.
