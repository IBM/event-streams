...
- You can upgrade the {{site.data.reuse.short_name}} operator to the latest 3.0.2 version directly from versions 3.0.x, 2.5.x, and 2.4.x. If you have an earlier operator version than 2.4.0, you must first upgrade it to 2.4.0 before upgrading to 3.0.x.
- You can upgrade the {{site.data.reuse.short_name}} operand to the latest 11.0.2 version directly from versions 11.0.x, 10.5.x, and 10.4.x. If you have an earlier operand version than 10.4.0, you must first upgrade it [to 10.4.0](../../10.4/installing/upgrading/) before upgrading to 11.0.x.
...
4. Upgrade your {{site.data.reuse.short_name}} version to the latest CD release by following the instructions on this page starting with the [prerequisites](#prerequisites) (operator version 3.0.2 and operand version 11.0.2).
...
6. In the YAML, change the `spec.version` field to the required version, for example, 11.0.2.
...
Alternatively, you can also upgrade your {{site.data.reuse.short_name}} instance in the {{site.data.reuse.cp4i}} Platform UI as follows:
   ...
   5. Select **11.0.2** from the **Select a new channel or version** list.
...
Upgrade the {{site.data.reuse.short_name}} instance to move to the required version, where `X.Y.Z` is the required version, for example, 11.0.2.
