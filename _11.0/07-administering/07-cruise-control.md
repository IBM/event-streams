...
For more information about optimization proposals, see the Strimzi [documentation](https://strimzi.io/docs/operators/0.27.1/using.html#con-optimization-proposals-str){:target="_blank"}.
