...
Enhance your security by encrypting the internal communication between {{site.data.reuse.short_name}} pods [by using TLS](../encrypting-data/#enabling-encryption-between-pods).
