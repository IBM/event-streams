...
**Note:** To auto-register schemas in the {{site.data.reuse.short_name}} schema registry, you need credentials that have operator role permissions (or higher) and permission to create schemas. You can generate credentials by using the {{site.data.reuse.short_name}} [UI](../../security/managing-access/#creating-a-kafkauser-in-the-ibm-event-streams-ui) or [CLI](../../security/managing-access/#creating-a-kafkauser-in-the-ibm-event-streams-cli).
