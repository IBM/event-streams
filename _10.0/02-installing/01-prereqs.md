...
Version 10.0.0 is installed by the {{site.data.reuse.short_name}} operator 2.0.0, and includes Kafka version 2.5.0. For an overview of supported component and platform versions, see the [support matrix](../../support/#support-matrix).
